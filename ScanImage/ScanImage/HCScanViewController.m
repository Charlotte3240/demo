...
@property (weak, nonatomic) IBOutlet UIView *preView; //预览层
...
- (void)cameraSetting{
    ...
    // Device
    //使用前置摄像头 AVCaptureDevicePositionFront
    ...
    _preview.connection.videoOrientation = [self getDeviceDirection];
    [self.preView.layer insertSublayer:self.preview atIndex:0];
